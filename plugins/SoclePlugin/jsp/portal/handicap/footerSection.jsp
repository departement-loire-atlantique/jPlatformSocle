	...
	<div class="grid-12-small-1 has-gutter-l">
	    <div class="col-2-small-1">
	        <div class="ds44-logo ds44-mb3 ds44-mobile-reduced-mt ds44-mobile-reduced-pt">
	           <img src="//design.loire-atlantique.fr/assets/images/logos/logo-mdph-2023.svg" alt="la MDPH - Maison départementale des personnes handicapées de Loire Atlantique" class="mbm">
