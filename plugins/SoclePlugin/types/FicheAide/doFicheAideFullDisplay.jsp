					...
					<div id="id_first" class="js-tabcontent ds44-tabs__content ds44-inner-container ds44-xl-margin-tb" 
						...
						<div class="grid-12-small-1">
							<div class="col-7">
								...
								<button onclick="document.getElementById('label_id_second').click();MiscUtils.scrollTo(MiscUtils.getPositionY(document.getElementById('label_id_second')))" class="js-tablist__link ds44-btnStd ds44-btnStd--large ds44-btn--invert" 
