...
<form role="search" novalidate method="get" name="queryForm" action="plugins/SoclePlugin/types/PortletSearch/query.jsp" data-legacy-url='<%= channel.getProperty("jcmsplugin.socle.url-rewriting.disabled")%>'>
   <div class="ds44-form__container">
      <div class="ds44-posRel">
         ...
         <input type="text" id="form-element-<%= formUid %>" name="searchtext" class="ds44-inpLarge" data-url="plugins/SoclePlugin/jsp/facettes/acSearchResult.jsp" role="combobox" aria-autocomplete="list" autocomplete="off" aria-expanded="false" data-mode="free-text" title='<%= glp("jcmsplugin.socle.facette.champ-obligatoire.title", glp("jcmsplugin.socle.recherche.votrerecherche")) %>' required="" aria-describedby="inp-rech"><button class="ds44-reset" type="button"><i class="icon icon-cross icon--sizeXL" aria-hidden="true"></i><span class="visually-hidden"><%= glp("jcmsplugin.socle.facette.effacer-contenu-champ", glp("jcmsplugin.socle.recherche.votrerecherche")) %></span></button>
