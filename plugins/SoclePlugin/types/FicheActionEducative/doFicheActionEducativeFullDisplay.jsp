                    ...
                    <div class="grid-<%= hasImage ? "2" : "1" %>-small-1">
                        ...
                        <div class='col mrl mbs<%= Util.isEmpty(obj.getImageMobile()) ? " ds44-hide-mobile" : ""%>'>
                           ...
                           <picture class="ds44-legendeContainer ds44-container-imgRatio" role="figure">
                              ...
                              <img src="<%=SocleUtils.getUrlOfFormattedImagePrincipale(obj.getImagePrincipale())%>" alt='<%= Util.isEmpty(obj.getTexteAlternatif()) ? HttpUtil.encodeForHTMLAttribute(JcmsUtil.glp(userLang, "jcmsplugin.socle.illustration")) : HttpUtil.encodeForHTMLAttribute(obj.getTexteAlternatif()) %>' class="ds44-w100 ds44-imgRatio" id="imageRatio<%=uid%>"/>
                           </picture>
                           <jalios:if predicate="<%= hasFigcaption%>">
