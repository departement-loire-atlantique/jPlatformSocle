    ...
    <div class="ds44-blocBandeau ds44-header">
        <div class="ds44-container-large">
            ...
            <ul class="ds44-list ds44-skiplinks">
                ...
                <li><a href="/accessibilite" class="ds44-skiplinks--link"><%= glp("jcmsplugin.socle.skiplinks.accessibility") %></a></li>
            </ul>
...
<%--                         <jsp:include page="socialNetworksHeader.jspf"/>  --%>
        ...
        <%@include file="/plugins/SoclePlugin/jsp/portal/sitesEtApplis.jspf" %>

                            
        </section>
        
        <jalios:if predicate="<%= displaySearchMenu %>">
            <%@ include file="/plugins/SoclePlugin/jsp/portal/blocMenuRecherche.jspf" %>
        </jalios:if>        
