...
<nav role="navigation" aria-label='<%=glp("jcmsplugin.socle.breadcrumb.position")%>' class="ds44-hide-mobile">
    <ul class="ds44-list ds44-breadcrumb <%=textColorStyle%>">
        <li class="ds44-breadcrumb_item"><a href="index.jsp" title="<%= lblAltTitle %> <%=channel.getName()%>"><i class="icon icon-home icon--medium"></i><span class="visually-hidden">Accueil</span></a></li>
