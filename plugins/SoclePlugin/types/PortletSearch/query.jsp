                       ...
                       <div class="ds44-fieldContainer ds44-fg1">                                          
                            <div class="ds44-form__container">      
                                <div class="ds44-posRel">
                                    ...
                                    <input type="text" id="form-element-<%= formUid %>" name="searchtext" class="ds44-inpLarge" data-url="plugins/SoclePlugin/jsp/facettes/acSearchResult.jsp" role="combobox" aria-autocomplete="list" aria-expanded="false" autocomplete="off" data-mode="free-text" title='<%= HttpUtil.encodeForHTML(glp("jcmsplugin.socle.facette.champ-obligatoire.title", glp("jcmsplugin.socle.recherche.votrerecherche"))) %>' required=""/><button class="ds44-reset" type="button" ><i class="icon icon-cross icon--sizeXL" aria-hidden="true"></i><span class="visually-hidden"><%= glp("jcmsplugin.socle.facette.effacer-contenu-champ", glp("jcmsplugin.socle.recherche.votrerecherche")) %></span></button>
