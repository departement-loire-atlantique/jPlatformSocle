        ...
        <div class="ds44-innerBoxContainer">
            ...
            <jalios:if predicate="<%= hasBottomInfos %>">
	            ...
	            <div class="ds44-docListElem ds44-mt-std"><i class="icon icon-marker ds44-docListIco" aria-hidden="true"></i>
	                <jalios:wysiwyg><%= pub.getCouncilBuildingAddress() %></jalios:wysiwyg>
	                <%= SocleUtils.formatAddress(null, null, null, null, null, null, pub.getPostalBox(), pub.getZipCode(), null, null) %>
	            </div>
            </jalios:if>
        </div>
