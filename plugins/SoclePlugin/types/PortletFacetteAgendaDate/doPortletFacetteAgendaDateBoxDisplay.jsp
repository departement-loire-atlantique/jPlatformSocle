...
HashMap<String, String> datesLabelValues = new HashMap<>();
datesLabelValues.put(glp("jcmsplugin.socle.facette.date.select.today.label"), InfolocaleUtil.getDateTodayInfolocale());
datesLabelValues.put(glp("jcmsplugin.socle.facette.date.select.tomorrow.label"), InfolocaleUtil.getDateTodayInfolocale());
datesLabelValues.put(glp("jcmsplugin.socle.facette.date.select.weekend.label"), InfolocaleUtil.getDateTodayInfolocale());
datesLabelValues.put(glp("jcmsplugin.socle.facette.date.select.nextseven.label"), InfolocaleUtil.getDateTodayInfolocale());
