...
%>
<%@ attribute name="complement"
    required="false"
    fragment="false"
    rtexprvalue="true"
    type="String"
    description="Texte complémentaire à afficher (si renseignée)"
%>
