...
<% 
  ...
  boolean siteArchives = channel.getBooleanProperty("jcmsplugin.archives.issitearchives", false);
%>
<%-- Name ------------------------------------------------------------ --%>
...
<%-- Ville ------------------------------------------------------------ --%>
<jalios:if predicate='<%= (multilingue && userLang.equals("fr")) || siteArchives %>'>
