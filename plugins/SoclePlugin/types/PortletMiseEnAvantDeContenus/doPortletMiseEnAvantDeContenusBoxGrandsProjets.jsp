	        ...
	        <div class="grid-12-small-1 grid-12-medium-1 ds44-flex-valign-center">
				...
				<div class="col-4 colFocusProjets mbm">
                    ...
                    <jalios:if predicate='<%=Util.notEmpty(box.getLabelDuLien()) %>'>
                        <p><a href="<%= urlBouton %>" <%= titleAttr %> <%= targetAttr %> class="ds44-btnStd ds44-btnStd--large ds44-hide-tiny-to-medium ds44-btnFullMobile"><span class="ds44-btnInnerText"><%= box.getLabelDuLien() %></span><i class="icon icon-long-arrow-right" aria-hidden="true"></i></a></p>
                    </jalios:if>
				</div>
	            ...
	            <%-- Bouton mobile --%>
                <jalios:if predicate='<%=Util.notEmpty(box.getLabelDuLien()) %>'>
                    <p><a href="<%= urlBouton %>" <%= titleAttr %> <%= targetAttr %> class="ds44-btnStd ds44-show-tiny-to-medium ds44-show-mobile ds44-btnFullMobile"><span class="ds44-btnInnerText"><%= box.getLabelDuLien() %></span><i class="icon icon-long-arrow-right" aria-hidden="true"></i></a></p>
                </jalios:if>
	      </div>
	    </div>
	</section>
