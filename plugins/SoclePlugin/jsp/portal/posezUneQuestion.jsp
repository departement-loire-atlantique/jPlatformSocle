...
<jalios:if predicate='<%= Util.notEmpty(portletFaq) %>'>
    ...
    <div<%= styleCss %>>
        ...
        <section class="ds44-modal-container" id="navFAQ" aria-modal="true" aria-hidden="true" role="dialog" aria-labelledby="uid_<%= uid %>">
            <div class="ds44-modal-box ds44-whiteBG ds44-wave-grey" role="document">
                ...
                <div class="ds44-container-menuBackLink">
                    <p id="uid_<%= uid %>" role="heading" aria-level="1" class="ds44-menuBackLink"><%= glp("jcmsplugin.socle.faq.vous-avez-question") %></p>
                </div>
