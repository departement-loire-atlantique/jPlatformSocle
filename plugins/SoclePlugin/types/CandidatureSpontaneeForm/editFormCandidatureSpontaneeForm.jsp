...
<% String[] formTitles = JcmsUtil.getLanguageArray(channel.getTypeEntry(CandidatureSpontaneeForm.class).getLabelMap()); %>
<jsp:useBean id='formHandler' scope='page' class='generated.EditCandidatureSpontaneeFormHandler'>
...
<% request.setAttribute("titreFormulaire", glp("jcmsplugin.socle.form.candidature-spontanee.titre")); %>
...
<form action='<%= formAction %>' method='post' name='editForm' accept-charset="UTF-8"  enctype="multipart/form-data">
    ...
    <jsp:include page="doEditCandidatureSpontaneeForm.jsp" />
