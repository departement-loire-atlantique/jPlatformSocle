...
<main role="main" id="content">
    ...
    <section class="ds44-container-large">
        ...
        <ds:titleBanner imagePath="<%=imageFile %>" mobileImagePath="<%=imageMobileFile %>" title="<%=title %>" legend="<%=legende %>" copyright="<%=copyright%>" breadcrumb="true" pubId='<%= obj.getId() %>')></ds:titleBanner>
