                ...
                <div class="grid-12-small-1 grid-12-medium-1 ds44-theme">
                    ...
                    <div class="col-7 ds44-mlr4 ds44--xxl-padding-t ds44-mobile-reduced-pad ds44-mobile-reduced-mar">
                        ...
                        <jalios:if predicate='<%= Util.notEmpty(obj.getUrlLiseuse(userLang, false)) %>'>
                            <p class="ds44-mt4">
                            <% String titleBtnLiseuse = Util.notEmpty(obj.getLibelleBoutonLiseuse(userLang, false)) ? glp("jcmsplugin.socle.fichepublication.lire.title.newtab.custom", obj.getTitreUne(userLang)+" - "+obj.getTitle(userLang), obj.getLibelleBoutonLiseuse(userLang, false)) : glp("jcmsplugin.socle.fichepublication.lire.title",obj.getTitreUne(userLang)+" - "+obj.getTitle(userLang)); %>
