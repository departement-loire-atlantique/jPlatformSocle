...
<section class="ds44-card ds44-js-card ds44-card--contact ds44-box ds44-bgGray  ">
    ...
    <div class="ds44-card__section">
        <div class="ds44-innerBoxContainer">
            ...
            <div class="ds44-docListElem ds44-mt-std"><i class="icon icon-date ds44-docListIco" aria-hidden="true"></i><jalios:wysiwyg><%= pub.getDepotDuDossier() %></jalios:wysiwyg></div>
        </div>
